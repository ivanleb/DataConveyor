...
namespace DataConveyor.Views.WPF.ViewModels
{
    public partial class NodesCanvasViewModel : ReactiveObject
    {
        ...
        static Dictionary<Themes, string> _themesPaths = new Dictionary<Themes, string>();
        ...
        private static void ThemePathsInit(IConfiguration configuration)
        {
            _themesPaths.Add(Themes.Dark, configuration.GetSection("Appearance:DarkThemePath").Get<String>());
            _themesPaths.Add(Themes.Light, configuration.GetSection("Appearance:LightThemePath").Get<String>());
        }
