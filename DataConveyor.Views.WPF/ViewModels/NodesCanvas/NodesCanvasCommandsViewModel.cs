...
namespace DataConveyor.Views.WPF.ViewModels
{
    public partial class NodesCanvasViewModel
    {
        ...
        private void SetTheme(Themes theme)
        {
            ...
            var uri = new Uri(_themesPaths[theme], UriKind.RelativeOrAbsolute);
        ...
        private void SelectConnects()
        {
            ...
            var connects = Connects.Where(x => Utils.CheckIntersectTwoRectangles(Utils.GetStartPointDiagonal(x.StartPoint, x.EndPoint), Utils.GetEndPointDiagonal(x.StartPoint, x.EndPoint),
                                               Utils.GetStartPointDiagonal(cutterStartPoint, cutterEndPoint), Utils.GetEndPointDiagonal(cutterStartPoint, cutterEndPoint)));
            ...
            foreach (var connect in connects)
            {
                connect.FromConnector.Selected = Utils.CheckIntersectCubicBezierCurveAndLine(connect.StartPoint, connect.Point1, connect.Point2, connect.EndPoint, cutterStartPoint, cutterEndPoint);
            }
        ...
        private void SelectNodes()
        {
            ...
            {
                node.Selected = Utils.CheckIntersectTwoRectangles(node.Point1, node.Point2, selectorPoint1, selectorPoint2);
            }
        }
